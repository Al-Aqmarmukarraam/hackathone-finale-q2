    ...
    <div className="items-center mx-auto my-14">
      ...
      <div className="flex flex-wrap gap-2 items-center justify-center mt-8">
        ...
        <div className="relative">
          <Image
            src="/card-image-1.png" // Corrected image path
            alt="card-image-1"
        ...
        <div className="relative">
          <Image
            src="/card-image-2.png" // Corrected image path
            alt="card-image-2"
        ...
        <div className="flex flex-row lg:flex-col gap-4 flex-wrap">
          ...
          <div className="relative  mx-auto items-center">
            <Image
              src="/card-image-4.png" // Corrected image path
              alt="card-image-3"
          ...
          <div className="relative  mx-auto items-center">
            <Image
              src="/card-image-5.png" // Corrected image path
              alt="card-image-4"
