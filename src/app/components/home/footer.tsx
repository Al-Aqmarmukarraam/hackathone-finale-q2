    ...
    <div className="">
      <div className=" py-0 md:py-28 md:w-full lg:h-[380px] h-full w-full justify-between">
        ...
        <div className="px-14 py-5 sm:flex flex-col md:flex-row lg:flex-row sm:space-x-10">
          ...
          <div className="space-y-4 w-full">
            ...
            <ul className={`${montserrat.className} text-sm`}>
              ...
              <Link href="">
                <li
                  className={`${montserrat.className} font-bold text-[14px] text-grey hover:text-blue-500`}
                >
                  Carrier
                </li>
              </Link>
          ...
          <div className="space-y-4 w-full">
            <h5
              className={`${montserrat.className} font-bold text-[16px] text-black hover:text-blue-500`}
            >
              Legal
            </h5>
            <ul className={`${montserrat.className} space-y-2 text-sm`}>
              <Link href="">
                <li
                  className={`${montserrat.className} font-bold text-[14px] text-black hover:text-blue-500`}
                >
                  About Us
                </li>
              </Link>
          ...
          <div className="flex flex-col space-y-4 w-full sm:w-[509px]">
            ...
            <div className="flex items-center lg:w-[321px] h-[48px] lg-h-[58] w-[250px]  border border-[#E6E6E6] rounded-lg overflow-hidden">
              ...
              <div className="flex-shrink-0">
                <button className="text-white bg-blue hover:text-black px-3 py-3 lg:px-6 lg:py-3 lg:w-full  lg-[58] h-[58] w-[97px] font-normal text-[14px]">
                  Subscribe
                </button>
              </div>
            </div>
            <p
              className={`${montserrat.className} font-normal text-[12px] text-black hover:text-blue-500`}
            >
        ...
        <div className="bg-myGrey/5">
          ...
          >
            Made With Love By AL-AQMAR MUKARRAM | All Right Reserved.
          </p>
        </div>
      </div>
    </div>
