...
import { FaAngleDown, FaHeart, FaSearch } from "react-icons/fa";
...
export default function Header() {
  ...
  return (
    <div className="w-full">
      {/* Navbar Light */}
      <div className="w-full px-4 sm:px-8 py-4 bg-green-600 ">
        <div className="flex items-center justify-between">
          {/* Logo */}
          <h3
            className={`${montserrat.className} font-bold text-xl lg:text-2xl text-[] hover:text-myBlue`}
          >
            Bandage
          </h3>
          ...
          <div className="hidden md:flex items-center md:space-x-2 lg:space-x-4">
            ...
            <div className="flex md:space-x-2 lg:space-x-4 items-center">
              {[
                { name: "search", link: "<FaSearch/>" },
                { name: "cart", link: "/cart" },
                { name: "heart", link: "<FaHeart/>" },
              ].map((icon) => (
                <Link
                  key={icon.name}
                  href={icon.link}
